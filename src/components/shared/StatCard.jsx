...
const StatCard = () => {
  return (
    <div className="flex flex-col relative bg-white shadow rounded overflow-hidden  mb-4 p-6 mx-auto">
      <div className="mx-auto flex space-x-[27px] pb-2 whitespace-nowrap border-b border-[#F4F4F4]">
        <p className="text-[12px] text-[#181818] font-[500]">YOUR DASHBOARD</p>
        <p className="text-[#0275B1] text-[12px] font-[500]">GO TO STAT</p>
      </div>
      <div className="pt-6">
