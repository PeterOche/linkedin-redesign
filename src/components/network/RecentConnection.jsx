...
const RecentConnection = ({ visitors }) => {
  return (
    <div className="grid grid-cols-2 relative bg-[#F7F9FB] rounded overflow-hidden mt-8 mb-4 p-6 gap-4 mx-auto">
      {visitors.map((visitor, index) => (
        <div
          key={index}
          className="flex items-center justify-center bg-[#FFFFFF] p-5 rounded mb-3"
        >
          <img
